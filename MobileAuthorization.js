...
window.location.href = "/sites/Finance/ExpenseClaimSystem/SitePages/Authorization.aspx";
});
...
function loadTable(){
var requestUri = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('TelephoneBroadbandClaims')/items?$filter=(substringof('"+loggedInUserEmail +"',PendingWithEmail) and Status eq 'Pending' and PendingWith eq 'Authorization')&$top=5000";
    tableContent = "";
    tableContents = "";
