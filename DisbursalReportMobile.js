...
window.location.href = "/sites/Finance/ExpenseClaimSystem/SitePages/DisbursalReportOE.aspx";
});
});
...
function loadTable(){
debugger;
var requestUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('TelephoneBroadbandClaims')/items?$filter=(PendingWith eq 'Approved' and AmountDisbursed eq 'No')&$top=4999";
