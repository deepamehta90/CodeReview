...
window.location.href = "/sites/Finance/ExpenseClaimSystem/SitePages/SubmissionVerification.aspx";
});
...
function loadTable(){
var requestUri = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('TelephoneBroadbandClaims')/items?$filter=(substringof('"+loggedInUserEmail +"',PendingWithEmail) and Status eq 'Pending' and PendingWith eq 'Submission And Verification')&$top=5000";
    tableContent = "";
    tableContents = "";
...
//var arrayAccountDetail = [];
   ...
   success: function(data) {
        ...
        var leng = objItems.length;
   		accountDetailHTML += '<table class="table table-bordered account-head-details"  style="table-layout:fixed;" ><thead><tr><th class="hide_column">ID</th><th>Account Head(s)</th><th>Particular(s)</th><th>From Date</th><th>To Date</th><th>Month</th><th>Claimed Amount</th><th>Approved Amount</th><th scope="col">Attachments</th></tr></thead><tbody>';
